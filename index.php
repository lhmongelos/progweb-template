									...
									<div class="banner_text">
										...
										<form class="navbar-form navbar-left w3_search" action="#" method="post">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                            <input type="search" class="form-control" placeholder="MODELO" required="">
                                                                                    </div>

                                                                                    <div class="form-group">
                                                                                            <input type="search" class="form-control" placeholder="FABRICANTE" required="">
                                                                                    </div>

                                                                                    <div class="form-group">
                                                                                            <input type="search" class="form-control" placeholder="LOCALIDADE" required="">
                                                                                    </div> 

                                                                                    <div class="form-group">
                                                                                            <input type="search" class="form-control" placeholder="ANO" required="">
                                                                                    </div>
                                        ...
                                        <br>
                                        <div class="form-group">
                                              <input type="submit" value="BUSCAR" name="BuscarVeiculo" />                                                
                                        </div>
				</div>

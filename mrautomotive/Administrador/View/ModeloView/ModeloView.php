...
<div id="dvCategoriaView">
    ...
    <div class="panel panel-default maxPanelWidth">
            <div class="panel-heading">CADASTRAR E EDITAR MODELOS</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <label for="txtNome">Nome do Modelo</label>
                                <input type="text" class="form-control" id="txtNome" name="txtNome" placeholder="ex: Uno" value="<?= $nome; ?>">
                            </div>
                        </div>

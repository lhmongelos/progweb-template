        ...
        <div class="panel-body">
            <form method="post" id="frmGerenciarClassificado" name="frmGerenciarClassificado" novalidate>
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="form-group">
                            <label for="txtNome">Titulo do Anuncio</label>
                    ...
                    <div class="col-lg-3 col-xs-12">
                        <div class="form-group">
                            <label for="slTipo">Marca</label>
                            <select class="form-control" id="slTipo" name="slTipo">
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Fiat</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Toyota</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Volkswagen</option>
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Ford</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Nissan</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Honda</option>
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Hyundai</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Kia</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Chevrolet</option>
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Fiat</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Toyota</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Renault</option>
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Mercedes</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Suzuki</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Jeep</option>
                                <option value="1" <?= ($tipo == 1 ? "selected='selected'" : ""); ?>>Citroen</option>
                                <option value="2" <?= ($tipo == 2 ? "selected='selected'" : ""); ?> >Land Rover</option>
                                <option value="3" <?= ($tipo == 3 ? "selected='selected'" : ""); ?>>Mitsubishi</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-12">
                        <div class="form-group">
                            <label for="slPerfil">Modelo do veiculo</label>
                            <select class="form-control" id="slPerfil" name="slPerfil">
                                <option value="1" <?= ($perfil == 1 ? "selected='selected'" : ""); ?>>Uno</option>
                                <option value="2" <?= ($perfil == 2 ? "selected='selected'" : ""); ?>>Mobi</option>
                                <option value="1" <?= ($perfil == 1 ? "selected='selected'" : ""); ?>>Siena</option>
                                <option value="2" <?= ($perfil == 2 ? "selected='selected'" : ""); ?>>Fiorino</option>
                                <option value="1" <?= ($perfil == 1 ? "selected='selected'" : ""); ?>>Argo</option>
                                <option value="2" <?= ($perfil == 2 ? "selected='selected'" : ""); ?>>Freemont</option>
                                <option value="1" <?= ($perfil == 1 ? "selected='selected'" : ""); ?>>Toro</option>
                                <option value="2" <?= ($perfil == 2 ? "selected='selected'" : ""); ?>>Strada</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="panel-body">
            <form method="post" name="frmBuscar" id="frmBuscar" action="#dvBusca">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-12">
                        <div class="form-group">
                            <label for="slTipoBusca">Marca do veiculoo</label>
                ...
                <div class="row">
                    <div class="col-lg-4 col-xs-12">
                        <div class="form-group">
                            <label for="slPerfilBusca">Id do anunciante</label>

            ...
            <form method="post" name="frmAnunciar" id="frmAnunciar">
                ...
                <div class="linha">
                    <div class="grid-50 mobile-grid-100 coluna">
                        <label for="txtNomeProduto">Titulo do classificado</label>
                    ...
                    <div class="grid-50 mobile-grid-100 coluna">
                        <label for="slCategoria">Marca do veiculo</label>
                    ...
                    <div class="grid-50 mobile-grid-100 coluna">
                        <label for="slCategoria">Modelo do Veiculo</label>
                        <select id="slCategoria" name="slCategoria"  <?= ($edit ? "disabled='disabled'" : "") ?>>
                            <option value="">Selecione</option>
                            <?php
                            foreach ($listaResumida as $cat) {
                    ...
                    <div class="grid-50 mobile-grid-100 coluna">
                        <label for="txtNomeProduto">Kilometragem</label>
                        <input type="text" id="txtkilometragem" name="txtKilometragem" placeholder="10,000" value="<?= $nome; ?>" <?= ($edit == true ? "disabled='disabled'" : "") ?>/>
                    </div>

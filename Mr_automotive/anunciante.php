    ...
    <div class="card p-3">
      <div class="e-navlist e-navlist--active-bg">
        ...
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link px-2" href="#"><i class="fa fa-fw fa-th mr-1"></i><span>Anuncios</span></a></li>
          <li class="nav-item"><a class="nav-link px-2" href="#"><i class="fa fa-fw fa-cog mr-1"></i><span>Anunciar</span></a></li>
        </ul>
      </div>
    </div>
  </div>

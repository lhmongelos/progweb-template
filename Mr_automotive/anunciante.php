...
<head>
	...
	<link href="css/anunciante.css" rel="stylesheet" type="text/css" />
	<!-- luizineo css-->
</head>
<body>
	<!-- banner -->
				...
				<div class="banner-header">
                    <div class="slider">                        
                        <div class="form-title">
                            <h2 class="dds">Dados Pessoais</h2>
							<form class="navbar-form navbar-left w3_search anunciante">
